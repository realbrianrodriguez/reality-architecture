            ...
            <div className="space-y-8 md:space-y-12">
              ...
              {debugMode && (
                <GlassPanel variant="tight" delay={600} className="reveal border-2 border-blue-300/50">
                  <h2 className="text-2xl md:text-3xl font-semibold text-[#050505] mb-4">
                    Debug Info
                  </h2>
                  <div className="space-y-4">
                    <div>
                      <p className="text-sm font-normal text-[rgba(5,5,5,0.48)] mb-2">HTTP Status:</p>
                      <p className="text-lg leading-relaxed font-normal text-[rgba(5,5,5,0.72)] font-mono">{httpStatus ?? 'N/A'}</p>
                    </div>
                    <div>
                      <p className="text-sm font-normal text-[rgba(5,5,5,0.48)] mb-2">Raw Response:</p>
                      <pre className="text-sm font-normal text-[rgba(5,5,5,0.72)] bg-[rgba(5,5,5,0.05)] p-4 rounded overflow-auto max-h-96 font-mono">
